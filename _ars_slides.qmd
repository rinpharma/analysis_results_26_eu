## What Are We Building? An AE Table Shell {.smaller}
...
::: {.table-note}
`xx` = placeholder values. SOCs listed alphabetically. N = subjects in Safety Analysis Set; n (%) = subjects with &ge;1 event in category.
:::
